...
class Cache_memcached extends CI_Driver {
     ...
     * @param string $dir
     */
    public function set_dir($dir = '_dir'){
        $this->_dir = $dir;
    }
    ...
    public function get_dir(){
        if(!@$this->_memcached->get($this->_dir)){
            $this->_memcached->set($this->_dir, time().'');
        }
        return $this->_memcached->get($this->_dir);
    }
	...
	{
	    if($dir){
	        return $this->_memcached->set($dir, time().'');
	    }else{
