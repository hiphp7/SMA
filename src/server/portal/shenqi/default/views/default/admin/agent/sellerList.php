					...
					<div class="col-sm-12">
					    <form method="get" action="">
						    ...
						    <label class="col-sm-1">
							    <a class="btn btn-sm btn-primary" href="<?php echo admin_base_url('agent/seller/info')?>">
...
<!--                            <th>QQ号码</th> -->
    ...
    if($lc_list){?>
                          ...
                          <tr>
                            ...
                            <td><a href="<?php echo admin_base_url('agent/seller/show?id='.$item->sellerid);?>"><?php echo $item->sellerid;?></a></td>
