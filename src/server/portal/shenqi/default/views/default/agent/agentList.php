					...
					<div class="col-sm-12">
					    <form method="get" action="">
						    ...
						    <label class="col-sm-1">
							    <a class="btn btn-sm btn-primary" href="<?php echo base_url('agent/agent/info')?>">
...
-->
    ...
    if($lc_list){?>
                          ...
                          <tr>
                            ...
                            <td><a href="<?php echo base_url('agent/agent/show?id='.$item->agentid);?>"><?php echo $item->agentid;?></a></td>
                          ...
                          <!--  <td><?php echo $item->qq;?></td> -->
                            ...
                            <td><div class="visible-md visible-lg hidden-sm hidden-xs action-buttons"><a href="<?php echo base_url('agent/agent/modify_pwd?id='.$item->agentid);?>"><i class="icon-undo bigger-130"></i></a></div></td>
                          </tr>
                          <?php endforeach;?>
                     <?php }else{?>
														<tr><td colspan="10" style="text-align:center;">未找到数据</td></tr>
 											<?php	}?>
	                </tbody>
	            </table>
