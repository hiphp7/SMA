...
echo ace_dropdown($data,'contentid',$titles,$item->contentid,' disabled="disabled"');
...
<div class="form-group">
		    ...
		    <div class="help-block col-xs-12 col-sm-reset inline">请先下载模板文件,模板为txt文件,请使用记事本编辑,utf-8编>码保存</div>                                                                      
		    </div>
<div class="form-group">
