...
$lang['required']			= "%s不能为空。";
$lang['isset']				= "%s必须输入。";
$lang['valid_email']		= "%s不是一个有效的邮箱格式。";
$lang['valid_emails']		= "%s不是一个有效的邮箱格式。";
$lang['valid_url']			= "%s不是有效的URL地址。";
$lang['valid_ip']			= "%s field must contain a valid IP。";
$lang['min_length']			= "%s长度至少%s位字符。";
$lang['max_length']			= "%s长度最多%s位字符。";
$lang['exact_length']		= "%s字符长度必须为%s位。";
$lang['alpha']				= "%s只允许输入字母。";
$lang['alpha_numeric']		= "%s只允许输入字母和数字";
$lang['alpha_dash']			= "%s只允许输入字母/数字/下划线";
$lang['numeric']			= "%s必须为数字。";
...
/* Location: 。language/english/form_validation_lang.php */